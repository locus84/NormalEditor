Shader "NormalEditor/PaintShader"
{
	Properties
	{
		...
		SubShader
		{
			...
			Pass
			{
				...
				float4 frag(v2f_img i) : COLOR {
					...
					{
						lerpVal = cos((PI_2 * remainder) / (_Radius * (1 - _Hardness)));
					}

					col.a = max(col.a, lerpVal);
					col.xyz = lerp(float3(0,0,0), float3(1,1,1) * _Strength, col.a);
					return col;
				}
				ENDCG
			}
